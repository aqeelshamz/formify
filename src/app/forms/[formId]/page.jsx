		...
		<main>
			{formSubmitted ? (
				<div className="bg-white rounded-xl p-10">
					...
					<button className="btn btn-primary mt-10">⚡️ Create your Formify AI</button>
					<hr className="my-10" />
					<div className="flex items-center mt-5">
						<p>powered by</p>
						<p className="ml-2 text-xl font-semibold">Formify AI</p>
					</div>
				</div>
			) : loadingFormData ? (
			...
			<dialog id="my_modal_2" className="modal">
				<div className="modal-box w-11/12 max-w-3xl">
					...
					{isNFTValid ? (
						<p className="mt-5 text-xl text-green-500">✅ NFT verified!</p>
					) : (
						<p className="mt-5 text-xl text-red-500">❌ NFT is not valid</p>
					)}
					{!isNFTValid ? (
						""
					) : (
						<div className="mt-10 modal-action flex justify-center ">
